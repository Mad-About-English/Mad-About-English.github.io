...
const imagesObj = importAll(
  require.context("../../../public/assets/lessons/horizontal", false, /\.(png|jpe?g|svg)$/)
);

const images_h= Object.entries(imagesObj);
...
const Horizontal = (props) => {
  ...
  const maxSteps = images_h.length;
